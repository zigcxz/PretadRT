...
# ============================================================
# Hmol + Mordred base model
#
# Generated by:
#
# train_base_model_hmol_mordred.py
# ============================================================
...
# IMPORTANT:
#
# Must use the scaler fitted specifically on:
#
# Hmol + Mordred + Hcond
# ============================================================
...
# ============================================================
# Feature layout generated during data preparation
# ============================================================
...
# Used only as an additional leakage check at test time.
# ============================================================
...
def load_train_val_molecule_sets():
    ...
    if train_set & val_set:
        ...
        raise RuntimeError(
            "Global train/validation molecule overlap "
            "detected before test evaluation."
        )
...
def load_model_and_scaler():
    ...
    # ========================================================
    # Model continuous feature dimension
    #
    # model.inputs[0] = continuous feature input
    # model.inputs[1] = USP input
    # ========================================================
    ...
    if (
        ...
        raise RuntimeError(
            ...
            f"Model dim  = {model_feature_dim}\n"

            f"Scaler dim = {scaler_feature_dim}"
...
def evaluate_one(
    ...
    # IMPORTANT:
    #
    # Use ONLY the scaler trained on:
    #
    # Hmol + Mordred + Hcond
    # ========================================================
    ...
    # ========================================================
    # Add test SMILES if available
    #
    # train_test_valid_hmol_mordred_global_molecule.py saves this file.
    # ========================================================
    ...
    if os.path.exists(
        ...
        if (
            ...
            print(
                ...
                f"[WARNING] {dataset_id}: "
                "smiles_test.csv length "
...
def evaluate():
    ...
    for dataset_id in dataset_ids:
        ...
        # With a GLOBAL molecule split, a small LC dataset may
        # legitimately receive zero test molecules.
        if os.path.getsize(
            test_path
        ) == 0:
    ...
    # 10. MACRO METRICS
    #
    # Every chromatographic dataset has equal weight.
    # ========================================================
    ...
    # Sample-weighted MAE
    #
    # Should be equal / almost equal to pooled MAE.
    # ========================================================
    ...
    #
    # Keep dataset_id + SMILES.
    #
    # This will be very useful later for comparing:
    #
    # Original
    # vs
    # Hmol
